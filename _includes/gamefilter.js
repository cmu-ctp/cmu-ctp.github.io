(function() {
  ...
  var engine = itemsjs(data, {
    ...
    searchableFields: ["developers", "tags", "title", "content"]
  });
  ...
  function search(query) {
    ...
    var counter = gameElems.length - result.data.items.length;

    document.getElementById("count_hidden").innerText = counter;
    document.getElementById("count_total").innerText = gameElems.length;
